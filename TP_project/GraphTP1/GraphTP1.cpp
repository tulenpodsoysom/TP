...
// GraphTP1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGraphTP1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGraphTP1App

CGraphTP1App::CGraphTP1App()
{
...
// Единственный объект CGraphTP1App

CGraphTP1App theApp;


// Инициализация CGraphTP1App

BOOL CGraphTP1App::InitInstance()
{
