...
// TP_project.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTPprojectApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTPprojectApp

CTPprojectApp::CTPprojectApp()
{
...
// Единственный объект CTPprojectApp

CTPprojectApp theApp;


// Инициализация CTPprojectApp

BOOL CTPprojectApp::InitInstance()
{
