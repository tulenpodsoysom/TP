...
// GraphTP2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGraphTP2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CGraphTP2App

CGraphTP2App::CGraphTP2App()
{
...
// Единственный объект CGraphTP2App

CGraphTP2App theApp;


// Инициализация CGraphTP2App

BOOL CGraphTP2App::InitInstance()
{
